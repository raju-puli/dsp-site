...
const Theme = () => {
    useEffect(() => {
        gsap.set("#moon, .star", { opacity: 0, width: 35, height: 35 });
        gsap.set("#sun, #cloud, #moon", { x: 15, width: 35, height: 35 });
        gsap.set(".star", { x: 35, y: -5, width: 35, height: 35 });
        ...
        if (dayButton && nightButton) {
            dayButton.addEventListener("click", () => {
                ...
                nightButton.style.pointerEvents = "all";
            });
            ...
            nightButton.addEventListener("click", () => {
                ...
                gsap.to("#night", { duration: 1, background: "linear-gradient(to bottom, #f8eedb, #fff)", borderColor: "#65c0e7", ease: "power1.inOut" });
                gsap.to("#background", { duration: 1, background: "rgb(232 232 232)", ease: "power1.inOut" });
                gsap.to(".song-card", { duration: 1, background: "white", color: "#5a5a5a", ease: "power1.inOut" });
                gsap.to(".songs-list-menu", { duration: 1, background: "white", color: "#5a5a5a", ease: "power1.inOut" });
                gsap.to(".play-track-menu", { duration: 1, background: "white", color: "#5a5a5a", ease: "power1.inOut" });
                gsap.to(".menu-popup", { duration: 1, background: "white", color: "#5a5a5a", ease: "power1.inOut" });
                gsap.to("h3", { duration: 1, color: "#000", ease: "power1.inOut" });

                nightButton.style.pointerEvents = "none";
                setTimeout(() => {
                    dayButton.style.pointerEvents = "all";
                }, 1000);
            });
        }
    }, []);
    ...
    return (
        <>
            <div id="day">
                <svg version="1.1" id="darkmode" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="70px" height="35px" viewBox="0 0 369 171.667" enableBackground="new 0 0 369 171.667" >
                    <g>
